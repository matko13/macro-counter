...
| nazwę i wartości produktu | 656 gotowych produktów z polskiej kuchni w bazie |
...
Jedynym wyjątkiem jest „Twaróg ze Strzałkowa półtłusty" — wpisany wprost
z etykiety, bo jest jadany na tyle regularnie, że warto go mieć pod ręką bez
dodawania za każdym razem. Ma też wagę kostki (250 g), więc „kostka twarogu"
liczy się poprawnie. Szersza, markowa baza jest możliwa — patrz „Szersza baza
produktów" niżej.
...
Wbudowane 656 pozycji to produkty ogólne. Konkretny jogurt konkretnej marki
...
- Testy: **405 przypadków** przez Playwright (headless Chromium, część na
